  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 animate-gradient py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="about-us py-16 bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 mb-16">
          <div className="row">
            <div className="col-xs-12">
              <h3 className="section-title text-4xl text-white font-bold mb-4 relative z-10 animate-fade-in">
            ...
            <div className="flex flex-wrap items-start">
              ...
              <div className="w-full md:w-2/3 p-4 animate-slide-in-left">
                <h5 className="lead font-bold text-xl mb-4 text-white">
                ...
                <blockquote className="italic text-lg border-l-4 pl-4 border-yellow-500 my-6 text-gray-300">
              ...
              <div className="w-full md:w-1/3 p-4 flex flex-col items-center animate-slide-in-right">
                ...
                <div className="border-2 border-yellow-500 p-4 mb-6 w-full hover:scale-105 hover:shadow-xl hover:border-yellow-500 transition-all duration-300">
                  <img src={truck} alt="Truck" className="w-full h-auto mb-2" />
                  <figcaption className="text-center text-yellow-500 text-sm font-semibold mt-2">
                ...
                <div className="pdf-catalog mb-4 flex items-center border-2 border-yellow-500 p-3 rounded-lg hover:scale-105 hover:shadow-xl transition-all duration-300">
                  <i className="icon-document text-2xl mr-2 text-yellow-500"></i>
                ...
                <img
                  src={truck2}
                  alt="Truck 2"
                  className="w-full h-auto my-4 hover:scale-105 hover:shadow-xl hover:border-2 hover:border-yellow-500 transition-all duration-300"
                />
              </div>
            </div>
          </div>
        ...
        <section className="about-features mt-10 bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 mb-16">
          <div className="row">
            <div className="col-xs-12">
              <h3 className="section-title text-4xl text-white font-bold mb-4 relative z-10 animate-fade-in">
                <span className="absolute -left-3 -top-5 text-4xl font-bold text-purple-300 opacity-50 z-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Air Shipping */}
              <div className="flex flex-col items-center text-center p-4 border border-yellow-500 rounded-lg shadow-lg hover:scale-105 hover:shadow-xl hover:border-2 hover:border-yellow-500 transition-all duration-300 animate-fade-in">
                <FontAwesomeIcon
                  icon={faPlaneUp}
                  className="text-3xl text-yellow-500 mb-2"
                />
                <h5 className="text-xl font-semibold text-white">AIR SHIPPING</h5>
              ...
              <div className="flex flex-col items-center text-center p-4 border border-yellow-500 rounded-lg shadow-lg hover:scale-105 hover:shadow-xl hover:border-2 hover:border-yellow-500 transition-all duration-300 animate-fade-in">
                <FontAwesomeIcon
                  ...
                  className="text-3xl text-yellow-500 mb-2"
                />
                <h5 className="text-xl font-semibold text-white">GROUND LOGISTIC</h5>
                <p className="text-gray-300">
                  We can also offer outside storage facilities in Aberdeen and both
                  outside and inside storage in Cowdenbeath.
                </p>
              ...
              <div className="flex flex-col items-center text-center p-4 border border-yellow-500 rounded-lg shadow-lg hover:scale-105 hover:shadow-xl hover:border-2 hover:border-yellow-500 transition-all duration-300 animate-fade-in">
                <FontAwesomeIcon
                  ...
                  className="text-3xl text-yellow-500 mb-2"
                />
                <h5 className="text-xl font-semibold text-white">SEA TRANSPORTATION</h5>
                <p className="text-gray-300">
                  We can also offer outside storage facilities in Aberdeen and both
                  outside and inside storage in Cowdenbeath.
                </p>
              ...
              <div className="flex flex-col items-center text-center p-4 border border-yellow-500 rounded-lg shadow-lg hover:scale-105 hover:shadow-xl hover:border-2 hover:border-yellow-500 transition-all duration-300 animate-fade-in">
                <FontAwesomeIcon
                  ...
                  className="text-3xl text-yellow-500 mb-2"
                />
                <h5 className="text-xl font-semibold text-white">DOMESTIC CARGO</h5>
                <p className="text-gray-300">
                  We can also offer outside storage facilities in Aberdeen and both
                  outside and inside storage in Cowdenbeath.
                </p>
        ...
        <section className="members py-16 bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 mb-16">
          <div className="row">
            <div className="col-xs-12 mb-6">
              ...
              <p className="intro text-lg text-gray-300">
            ...
            <div className="flex flex-wrap justify-between mb-6">
              {members.map((member, index) => (
                <div key={index} className="member text-center w-full sm:w-1/2 md:w-1/4 px-2 mb-6 animate-fade-in">
                  <figure className="hover:scale-105 hover:shadow-xl hover:border-2 hover:border-yellow-500 transition-all duration-300">
                    <img
                      src={member.image}
                      alt={member.name}
                    ...
                    <figcaption>
                      ...
                      <small className="text-sm text-gray-300">{member.role}</small>
                    </figcaption>
                  </figure>
                </div>
              ))}
        ...
        {/* Section 4: CLIENTS */}
        <section className="clients py-16 bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 mb-12">
          <div className="row">
            <div className="col-xs-12">
