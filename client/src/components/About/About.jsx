  ...
  return (
    ...
    dark:to-gray-700 py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="about-us py-16 bg-white dark:bg-gray-900 backdrop-blur-lg rounded-lg shadow-2xl 
        hover:shadow-3xl transition-all duration-500 p-8 mb-16">
          <div className="row">
            <div className="col-xs-12">
              <h3 className="section-title text-4xl text-gray-800 dark:text-white font-bold mb-4 relative 
              z-10 animate-fade-in">
                <span className="absolute -left-3 -top-5 text-4xl font-bold text-purple-400 
                dark:text-purple-300 opacity-50 z-0">
                  01
                </span>
                SMART DELIVERY
              </h3>
            ...
            <div className="flex flex-wrap items-start">
              ...
              <div className="w-full md:w-2/3 p-4 animate-slide-in-left">
                <h5 className="lead font-bold text-xl mb-4 text-gray-800 dark:text-white">
                ...
                <blockquote className="italic text-lg border-l-4 pl-4 border-orange-600 my-6 text-gray-600 
                dark:text-gray-300">
                ...
                <blockquote className="italic text-lg border-l-4 pl-4 border-orange-600 my-6 
             ...
             {/* Right Side - Images, Caption, and PDF Download */}
              <div className="w-full md:w-1/3 p-4 flex flex-col items-center animate-slide-in-right">
                {/* Common Bordered Container for First Truck & Caption */}
                <div className="border-2 border-orange-600 p-4 mb-6 w-full hover:scale-105 hover:shadow-xl 
                :border-orange-600 transition-all duration-300">
                  <img src={truck} alt="Truck" className="w-full h-auto mb-2" />
                  <figcaption className="text-center text-orange-600 text-sm font-semibold mt-2">
                    Member of the Road Haulage Association
                  </figcaption>
                </div>

                {/* PDF Download Section */}
                <div className="pdf-catalog mb-4 flex items-center border-2 border-orange-600 p-3 
                rounded-lg hover:scale-105 hover:shadow-xl transition-all duration-300">
                  <i className="icon-document text-2xl mr-2 text-orange-600"></i>
                ...
                <img
                  src={truck2}
                  alt="Truck 2"
                  className="w-full h-auto my-4 hover:scale-105 hover:shadow-xl hover:border-2 
                  hover:border-orange-600 transition-all duration-300"
                />
              </div>
            </div>
          </div>
        ...
        <section className="about-features mt-10 bg-white dark:bg-gray-900 backdrop-blur-lg rounded-lg 
        shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 mb-16">
          <div className="row">
            <div className="col-xs-12">
              <h3 className="section-title text-4xl text-gray-800 dark:text-white font-bold mb-4 relative z-10 
              animate-fade-in">
                <span className="absolute -left-3 -top-5 text-4xl font-bold text-purple-400 
                dark:text-purple-300 opacity-50 z-0">
                  02
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              shadow-lg hover:scale-105 hover:shadow-xl hover:border-2 hover:border-orange-600 transition-all duration-300 animate-fade-in">
                ...
                />
                <h5 className="text-xl font-semibold text-gray-800 dark:text-white">AIR SHIPPING</h5>
              ...
              {/* Ground Logistic */}
              <div className="flex flex-col items-center text-center p-4 border border-orange-600 rounded-lg 
              shadow-lg hover:scale-105 hover:shadow-xl hover:border-2 hover:border-orange-600 transition-all 
              duration-300 animate-fade-in">
                <FontAwesomeIcon
                  icon={faCar}
                  className="text-3xl text-orange-600 mb-2"
                />
                <h5 className="text-xl font-semibold text-gray-800 dark:text-white">GROUND LOGISTIC</h5>
                <p className="text-gray-600 dark:text-gray-300">
                  We can also offer outside storage facilities in Aberdeen and both
                  outside and inside storage in Cowdenbeath.
                </p>
              ...
              duration-300 animate-fade-in">
                <FontAwesomeIcon
                  ...
                  className="text-3xl text-orange-600 mb-2"
                />
                <h5 className="text-xl font-semibold text-gray-800 dark:text-white">SEA TRANSPORTATION</h5>
                <p className="text-gray-600 dark:text-gray-300">
                  We can also offer outside storage facilities in Aberdeen and both
                  outside and inside storage in Cowdenbeath.
                </p>
              ...
              duration-300 animate-fade-in">
                <FontAwesomeIcon
                  ...
                  className="text-3xl text-orange-600 mb-2"
                />
                <h5 className="text-xl font-semibold text-gray-800 dark:text-white">DOMESTIC CARGO</h5>
                <p className="text-gray-600 dark:text-gray-300">
                  We can also offer outside storage facilities in Aberdeen and both
                  outside and inside storage in Cowdenbeath.
                </p>
        ...
        <section className="members py-16 bg-white dark:bg-gray-900 backdrop-blur-lg rounded-lg shadow-2xl 
        hover:shadow-3xl transition-all duration-500 p-8 mb-16">
          <div className="row">
            <div className="col-xs-12 mb-6">
              ...
              <p className="intro text-lg text-gray-600 dark:text-gray-300">
            ...
            <div className="flex flex-wrap justify-between mb-6">
              {members.map((member, index) => (
                ...
                animate-fade-in">
                  <figure className="hover:scale-105 hover:shadow-xl hover:border-2 hover:border-orange-600 
                  transition-all duration-300">
                    ...
                    />
                    <figcaption>
                      <h5 className="font-semibold text-gray-800 dark:text-white">{member.name}</h5>
                      <small className="text-sm text-gray-600 dark:text-gray-300">{member.role}</small>
                    </figcaption>
                  </figure>
                </div>
              ))}
        ...
        {/* Section 4: CLIENTS */}
        <section className="clients py-16 bg-white dark:bg-gray-900 backdrop-blur-lg rounded-lg shadow-2xl 
        hover:shadow-3xl transition-all duration-500 p-8 mb-12">
          <div className="row">
            <div className="col-xs-12">
                  ...
                  <li key={index} className="animate-fade-in">
                    ...
                    transition-all duration-300">
                      <img
                        src={logo}
                        alt={`Logo ${index + 1}`}
                        className="w-32 h-auto filter grayscale-100 hover:grayscale-0 transition-all 
                        duration-300"
                      />
                    </figure>
                  </li>
